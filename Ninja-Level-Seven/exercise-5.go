...
func (l PorApellido) Len() int           { return len(l) }
func (l PorApellido) Swap(i, j int)      { l[i], l[j] = l[j], l[i] }
func (l PorApellido) Less(i, j int) bool { return l[i].Apellido < l[j].Apellido }
